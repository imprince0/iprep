  ...
  return (
    <div>
        ...
        <div className='container w-25' style={{marginTop: "80px"}}>
            <h3>Click start for creating a new meet you as a host </h3>{'\n'}
            <i>Recommeded: use strong id and share with receiver this key will be the uniquely connected  both receiver</i>
            <input placeholder="Enter username..."
                    type="text" className='my-3'
                    id="username-input" />
            {/* <button onClick={sendFirst} className='btn btn-primary my-2'>Start Call</button> */}
            <button onClick={startCall} className='btn btn-primary my-2'>Start Call</button>
        </div>
